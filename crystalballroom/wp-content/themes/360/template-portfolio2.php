<?php
/*
Template Name: Template Portfolio Two Columns (AJAX)
*/
global $data;
?>
...
<div id="portfolio1" class="container">
    ...
    <div id="folio" class="two-columns">
    	...
    	<ul>
			...
			$imageblog = aq_resize( $img_url_blog, 480, 350, true );
            ?>
			...
			<li class="folio-item video">
				...
				<iframe src="<?php echo $video; ?>" width="480" height="350" frameborder="0" class="vid"></iframe>
