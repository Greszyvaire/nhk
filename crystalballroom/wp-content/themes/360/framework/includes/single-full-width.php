			...
			<div class="post" id="post-<?php the_ID(); ?>">
  	    		...
  	    		<h5 class="main-title-blog"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a><span class="post-type-image">&nbsp;</span></h5>
  	    		 ...
  	    		 <?php if ( (function_exists('has_post_thumbnail')) && (has_post_thumbnail()) ) : ?>
  	    		 	...
  	    		 	<?php 
						...
						$img_url_blog = wp_get_attachment_url( $thumbblog,'fullsize' );
						$imageblog = aq_resize( $img_url_blog, 880,true );
					?>
				...
				<div class="left-excerpt">
    				...
    				<ul>
        				...
        				<li class="written">Written by <?php the_author_meta('display_name'); ?></li>
        		
        				<li class="posted">Posted <?php echo human_time_diff(get_the_time('U'), current_time('timestamp')) .' '. __('ago', 'siiimple'); ?></li>
        	
        				<li class="comments"><?php comments_popup_link( 'No comments yet', '1 comment', '% comments', 'comments-link', 'Comments are off for this post'); ?></li>
