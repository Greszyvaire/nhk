	...
	<div class="grid16 col top-header">
		...
		<div class="blog-content-wrap">
			...
			<div class="grid10 col full-width" id="content-wrapper">
				...
				<?php query_posts( array('post_type'=> 'post','showposts' => '-1','paged'=>$paged )); ?>
...
<div class="post" id="post-<?php the_ID(); ?>">
	...
	<iframe src="<?php echo $video; ?>" width="960" height="500" frameborder="0" class="vid"></iframe>
...
<div class="post link" id="post-<?php the_ID(); ?>">
	...
	<a href="#"><?php the_content(); ?></a>
		...
		<p class="link-date">Posted <?php echo human_time_diff(get_the_time('U'), current_time('timestamp')) .' '. __('ago', 'siiimple'); ?></p>
